...
namespace Blessings.Controllers
{
    ...
    public class StaffsController : Controller
    {
        ...
        public StaffsController(BlessingsdbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StaffId,StaffFirstName,StaffLastName,Room,Street,City,State,Zipcode,Email,Phone")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,StaffFirstName,StaffLastName,Room,Street,City,State,Zipcode,Email,Phone")] Staff staff)
        {
            if (id != staff.StaffId)
            {
                return NotFound();
